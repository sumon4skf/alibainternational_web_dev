  ...
  <div class="card-body">
    <fieldset>
      ...
      <div class="form-group mb-0">
        ...
        ->autofocus(true)}}
        <small id="sms_waiting_for_payment_help" class="form-text text-muted mb-2">Place of OTP use <span
            class="text-danger">[otp]</span> and Place of URL use <span class="text-danger">[appUrl]</span></small>
        <a href="{{route('admin.setting.sms-test', 'sms_active_otp_message')}}" class="btn btn-primary">
          Test SMS
        </a>
      </div> <!-- form-group-->
    </fieldset>
