...
<div class="card card-default">
  <div class="card-header">
    ...
    <a class="btn btn-tool @if(request('only-active')) text-success @endif"
      href="/admin/taxonomy?only-active=true&only-parent={{request('only-parent')}}&only-is-top={{request('only-is-top')}}">
