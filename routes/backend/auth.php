...
Route::group([
  ...
  Route::group(['namespace' => 'User'], function () {
    ...
    Route::get('api/user', [UserController::class, 'api_user_index'])->name('api.user.index');
    Route::get('api/user/create', [UserController::class, 'api_user_create'])->name('api.user.create');
    Route::post('api/user/store', [UserController::class, 'api_user_store'])->name('api.user.store');
    Route::get('api/user/{user}/edit', [UserController::class, 'api_user_edit'])->name('api.user.edit');
    Route::patch('api/user/update/{user}', [UserController::class, 'api_user_update'])->name('api.user.update');
    Route::get('api/user/{user}/log', [UserController::class, 'api_user_log'])->name('api.user.log');
