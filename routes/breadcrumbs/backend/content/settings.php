...
Breadcrumbs::for('admin.setting.payment.gateway', function ($trail) {
  $trail->push('Payment Gateway Settings', route('admin.setting.payment.gateway'));
});
...
Breadcrumbs::for('admin.front-setting.three.col.banner', function ($trail) {
  $trail->push('Banner Right Settings', route('admin.front-setting.three.col.banner'));
});
