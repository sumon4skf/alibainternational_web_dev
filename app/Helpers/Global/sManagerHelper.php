...
if (!function_exists('sManagerTrnxDetails')) {
  function sManagerTrnxDetails($transaction_id)
  {
    ...
    $base_url = "https://api.dev-sheba.xyz/v1/ecom-payment/details?transaction_id=" . $transaction_id;
    if ($smanager_env == "smanager_live") {
      $base_url = "https://api.sheba.xyz/v1/ecom-payment/details?transaction_id=" . $transaction_id;
    }
