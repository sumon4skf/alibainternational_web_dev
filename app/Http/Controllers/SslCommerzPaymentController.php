...
class SslCommerzPaymentController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    if ($invoice || $order) {
      ...
      $phone = $user_phone ? $user_phone : ($address['phone_one'] ?? '01934812967');
      $phone = $phone ? $phone : '01934812967';

      $post_data['total_amount'] = round($amount); # You cant not pay less than 10
