...
class AddressController extends Controller
{
  ...
  public function edit($id)
  {
    ...
    $editForm['form'] = '';
    if ($address) {
      $editForm['form'] = view('frontend.user.address.edit', compact('address'))->render();
    }

    return response($editForm);
  }
  ...
  public function update(Request $request, Address $address)
  {
    $data = $this->addressValidator();
    $address->update($data);
    return redirect()->back()->withFlashSuccess('Address update successfully');
  }
